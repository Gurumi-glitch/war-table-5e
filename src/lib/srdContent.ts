...
export const SRD_CLASSES: SrdClass[] = [
  { id: "barbarian", nameZh: "野蠻人", nameEn: "Barbarian", hitDie: 12, saveProfs: ["力量", "體質"], caster: "none", skillChoose: 2, skillFrom: ["馴獸", "運動", "威嚇", "自然", "察覺", "求生"], armorProfs: ["輕甲", "中甲", "盾牌"], weaponProfs: ["簡易武器", "軍用武器"], subclassLabel: "始源之道", subclasses: [{ id: "berserker", nameZh: "狂戰士之道", nameEn: "Path of the Berserker", l1: false }] },
  { id: "bard", nameZh: "吟遊詩人", nameEn: "Bard", hitDie: 8, saveProfs: ["敏捷", "魅力"], caster: "full", spellAbility: "魅力", skillChoose: 3, skillFrom: ANY_SKILLS, armorProfs: ["輕甲"], weaponProfs: ["簡易武器", "手弩", "長劍", "刺劍", "短劍"], subclassLabel: "詩人學院", subclasses: [{ id: "college-of-lore", nameZh: "知識學院", nameEn: "College of Lore", l1: false }] },
  { id: "cleric", nameZh: "牧師", nameEn: "Cleric", hitDie: 8, saveProfs: ["感知", "魅力"], caster: "full", spellAbility: "感知", skillChoose: 2, skillFrom: ["歷史", "洞悉", "醫藥", "說服", "宗教"], armorProfs: ["輕甲", "中甲", "盾牌"], weaponProfs: ["簡易武器"], subclassLabel: "神聖領域", subclasses: [{ id: "life-domain", nameZh: "生命領域", nameEn: "Life Domain", l1: true, bonusArmorProfs: ["重甲"], l1FeatureText: "領域法術（祝福、療傷術）；生命門徒：以 1 環或更高法術回復生命時，額外回復 2 + 法術環階 點生命值。" }] },
  { id: "druid", nameZh: "德魯伊", nameEn: "Druid", hitDie: 8, saveProfs: ["智力", "感知"], caster: "full", spellAbility: "感知", skillChoose: 2, skillFrom: ["奧秘", "馴獸", "洞悉", "醫藥", "自然", "察覺", "宗教", "求生"], armorProfs: ["輕甲", "中甲", "盾牌"], weaponProfs: ["棍棒", "匕首", "飛鏢", "標槍", "硬頭錘", "木杖", "彎刀", "鐮刀", "投石索", "長矛"], subclassLabel: "德魯伊結社", subclasses: [{ id: "circle-of-the-land", nameZh: "土地結社", nameEn: "Circle of the Land", l1: false }] },
  { id: "fighter", nameZh: "戰士", nameEn: "Fighter", hitDie: 10, saveProfs: ["力量", "體質"], caster: "none", skillChoose: 2, skillFrom: ["特技", "馴獸", "運動", "歷史", "洞悉", "威嚇", "察覺", "求生"], armorProfs: ["輕甲", "中甲", "重甲", "盾牌"], weaponProfs: ["簡易武器", "軍用武器"], subclassLabel: "戰鬥原型", subclasses: [{ id: "champion", nameZh: "鬥士", nameEn: "Champion", l1: false }] },
  { id: "monk", nameZh: "武僧", nameEn: "Monk", hitDie: 8, saveProfs: ["力量", "敏捷"], caster: "none", skillChoose: 2, skillFrom: ["特技", "運動", "歷史", "洞悉", "宗教", "隱匿"], armorProfs: [], weaponProfs: ["簡易武器", "短劍"], subclassLabel: "武道傳承", subclasses: [{ id: "open-hand", nameZh: "空明拳之道", nameEn: "Way of the Open Hand", l1: false }] },
  { id: "paladin", nameZh: "聖騎士", nameEn: "Paladin", hitDie: 10, saveProfs: ["感知", "魅力"], caster: "half", spellAbility: "魅力", skillChoose: 2, skillFrom: ["運動", "洞悉", "威嚇", "醫藥", "說服", "宗教"], armorProfs: ["輕甲", "中甲", "重甲", "盾牌"], weaponProfs: ["簡易武器", "軍用武器"], subclassLabel: "神聖誓言", subclasses: [{ id: "oath-of-devotion", nameZh: "奉獻之誓", nameEn: "Oath of Devotion", l1: false }] },
  { id: "ranger", nameZh: "遊俠", nameEn: "Ranger", hitDie: 10, saveProfs: ["力量", "敏捷"], caster: "half", spellAbility: "感知", skillChoose: 3, skillFrom: ["馴獸", "運動", "洞悉", "調查", "自然", "察覺", "隱匿", "求生"], armorProfs: ["輕甲", "中甲", "盾牌"], weaponProfs: ["簡易武器", "軍用武器"], subclassLabel: "遊俠原型", subclasses: [{ id: "hunter", nameZh: "狩獵者", nameEn: "Hunter", l1: false }] },
  { id: "rogue", nameZh: "盜賊", nameEn: "Rogue", hitDie: 8, saveProfs: ["敏捷", "智力"], caster: "none", skillChoose: 4, skillFrom: ["特技", "運動", "欺瞞", "洞悉", "威嚇", "調查", "察覺", "表演", "說服", "巧手", "隱匿"], armorProfs: ["輕甲"], weaponProfs: ["簡易武器", "手弩", "長劍", "刺劍", "短劍"], subclassLabel: "盜賊原型", subclasses: [{ id: "thief", nameZh: "神偷", nameEn: "Thief", l1: false }] },
  { id: "sorcerer", nameZh: "術士", nameEn: "Sorcerer", hitDie: 6, saveProfs: ["體質", "魅力"], caster: "full", spellAbility: "魅力", skillChoose: 2, skillFrom: ["奧秘", "欺瞞", "洞悉", "威嚇", "說服", "宗教"], armorProfs: [], weaponProfs: ["匕首", "飛鏢", "投石索", "木杖", "輕弩"], subclassLabel: "術源", subclasses: [{ id: "draconic-bloodline", nameZh: "龍族血脈", nameEn: "Draconic Bloodline", l1: true, l1FeatureText: "龍族祖先；龍族韌性：生命值上限每術士等級 +1（1 級即 +1），未著甲時 AC = 13 + 敏捷。" }] },
  { id: "warlock", nameZh: "契術士", nameEn: "Warlock", hitDie: 8, saveProfs: ["感知", "魅力"], caster: "pact", spellAbility: "魅力", skillChoose: 2, skillFrom: ["奧秘", "欺瞞", "歷史", "威嚇", "調查", "自然", "宗教"], armorProfs: ["輕甲"], weaponProfs: ["簡易武器"], subclassLabel: "異界宗主", subclasses: [{ id: "the-fiend", nameZh: "魔鬼", nameEn: "The Fiend", l1: true, l1FeatureText: "擴展法術列表；黑暗祝福：使敵人生命值歸零時，獲得 魅力調整值 + 契術士等級 點臨時生命值。" }] },
  { id: "wizard", nameZh: "法師", nameEn: "Wizard", hitDie: 6, saveProfs: ["智力", "感知"], caster: "full", spellAbility: "智力", skillChoose: 2, skillFrom: ["奧秘", "歷史", "洞悉", "調查", "醫藥", "宗教"], armorProfs: [], weaponProfs: ["匕首", "飛鏢", "投石索", "木杖", "輕弩"], subclassLabel: "秘法傳統", subclasses: [{ id: "evocation", nameZh: "塑能學派", nameEn: "School of Evocation", l1: false }] },
];
